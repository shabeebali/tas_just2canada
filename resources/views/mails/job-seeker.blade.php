    ...
    <tr>
        <td>
            <div style="padding:20px;">
                Dear {{ $name }}.<br>
                Thank you for submitting the Job Seeker Questionnaire. Your assigned file number is : {{ $client_id  }}. You may quote this number in future correspondence with us.
