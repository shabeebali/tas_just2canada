        ...
        <form action="{{route('admin.users.store')}}" method="POST">
            ...
            <div class="flex items-center flex-col">
                <div class="p-6 space-y-6 w-1/2">
                    ...
                    @endif
                    <x-blocks.input-field type="text" label="Name" name="name" value="{{old('name')}}"></x-blocks.input-field>
                    <x-blocks.input-password-field type="password" label="Password" name="password" required></x-blocks.input-password-field>
                    <x-blocks.input-field type="email" label="Email" name="email" value="{{old('email')}}"></x-blocks.input-field>
                    ...
                    <select id="role" name="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        <option value="super_admin" @if(old('role') == 'super_admin') selected @endif>super_admin</option>
                    </select>
                </div>
                <!-- Modal footer -->
