...
<div class="absolute bg-slate-800 top-0 left-0 h-full mt-0 lg:mt-12 w-60 z-50 transform lg:transform-none lg:opacity-100 duration-200" :class="{'translate-x-0 ease-in opacity-100':showSidebar === true, '-translate-x-full ease-out opacity-0': showSidebar === false}">
