<div x-data="{showText: false}" {{$attributes}}>
    ...
    <div class="relative mb-6">
        <input :type="showText ? 'text':'password'" @if($required) required @endif id="{{ $name }}" name="{{ $name }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
