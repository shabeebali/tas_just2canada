...
class JobSeekerController extends Controller
{
    ...
    {
        $data = FormSubmission::select('id','client_id','form_data->full_name as name','form_data->email as email','form_data->current_residence as country','assessed_as')->where('form_type_id',3)->orderBy('created_at','DESC');
